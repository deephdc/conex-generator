...
training.learning_rate(4e-5, 4e-5).execute("all", 10000)
training.learning_rate(2e-5, 2e-5).execute("all", 10000)
training.learning_rate(1e-5, 1e-5).execute("all", 20000)
training.learning_rate(4e-6, 4e-6).execute("all", 10000)
training.learning_rate(2e-6, 2e-6).execute("all", 20000)
training.learning_rate(1e-6, 1e-6).execute("all", 30000)
