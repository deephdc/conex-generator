...
pipeline {
    ...
    environment {
        author_name = "Marcel Köpke, KIT/IKP"
        author_email = "marcel.koepke@kit.edu"
        app_name = "conex-generator"
        job_location = "Pipeline-as-code/DEEP-OC-org/DEEP-OC-conex-generator/${env.BRANCH_NAME}"
    }
